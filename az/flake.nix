{
  inputs = {
    ...
    c.url = github:defn/pkg/c-0.4.32?dir=c;
    n.url = github:defn/pkg/n-0.0.76?dir=n;
    tf.url = github:defn/pkg/tf-0.0.36?dir=tf;
    gum.url = github:defn/pkg/gum-0.10.0-29?dir=gum;
    glow.url = github:defn/pkg/glow-1.5.0-32?dir=glow;
  };
