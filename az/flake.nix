{
  inputs = {
    ...
    c.url = github:defn/pkg/c-0.4.20?dir=c;
    n.url = github:defn/pkg/n-0.0.63?dir=n;
    tf.url = github:defn/pkg/tf-0.0.24?dir=tf;
    gum.url = github:defn/pkg/gum-0.10.0-17?dir=gum;
    glow.url = github:defn/pkg/glow-1.5.0-20?dir=glow;
  };
