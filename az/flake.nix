{
  inputs = {
    ...
    c.url = github:defn/pkg/c-0.4.21?dir=c;
    n.url = github:defn/pkg/n-0.0.64?dir=n;
    tf.url = github:defn/pkg/tf-0.0.25?dir=tf;
    gum.url = github:defn/pkg/gum-0.10.0-18?dir=gum;
    glow.url = github:defn/pkg/glow-1.5.0-21?dir=glow;
  };
