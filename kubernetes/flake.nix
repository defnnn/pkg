{
  inputs = {
    ...
    k3d.url = github:defn/pkg/k3d-5.4.9-17?dir=k3d;
    kubectl.url = github:defn/pkg/kubectl-1.25.8-17?dir=kubectl;
    k9s.url = github:defn/pkg/k9s-0.27.3-19?dir=k9s;
    helm.url = github:defn/pkg/helm-3.11.2-20?dir=helm;
    kustomize.url = github:defn/pkg/kustomize-5.0.1-18?dir=kustomize;
    stern.url = github:defn/pkg/stern-1.24.0-19?dir=stern;
    argo.url = github:defn/pkg/argo-3.4.6-17?dir=argo;
    argocd.url = github:defn/pkg/argocd-2.6.7-18?dir=argocd;
    tkn.url = github:defn/pkg/tkn-0.30.0-20?dir=tkn;
    kn.url = github:defn/pkg/kn-1.9.2-18?dir=kn;
