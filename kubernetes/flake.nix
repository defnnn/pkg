{
  inputs = {
    ...
    k3d.url = github:defn/pkg/k3d-5.4.8-1?dir=k3d;
    kubectl.url = github:defn/pkg/kubectl-1.25.6-3?dir=kubectl;
    k9s.url = github:defn/pkg/k9s-0.27.3-1?dir=k9s;
    helm.url = github:defn/pkg/helm-3.11.2-2?dir=helm;
    kustomize.url = github:defn/pkg/kustomize-5.0.0-8?dir=kustomize;
    argocd.url = github:defn/pkg/argocd-argocd-2.5.5-0?dir=argocd;
    kn.url = github:defn/pkg/kn-1.9.1-1?dir=kn;
  };
