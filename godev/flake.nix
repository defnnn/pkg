{
  inputs = {
    ...
    buf.url = github:defn/pkg/buf-1.17.0-1?dir=buf;
    operatorsdk.url = github:defn/pkg/operatorsdk-1.28.0-29?dir=operatorsdk;
    goreleaser.url = github:defn/pkg/goreleaser-1.16.2-29?dir=goreleaser;
    cosign.url = github:defn/pkg/cosign-2.0.1-1?dir=cosign;
