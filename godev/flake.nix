{
  inputs = {
    ...
    cobracli.url = github:defn/cobracli/1.6.1-2;
    buf.url = github:defn/pkg/buf-1.15.1-1?dir=buf;
    operatorsdk.url = github:defn/pkg/operatorsdk-1.27.0-1?dir=operatorsdk;
    goreleaser.url = github:defn/pkg/goreleaser-1.16.1-1?dir=goreleaser;
    cosign.url = github:defn/pkg/cosign-2.0.0-3?dir=cosign;
