{
  inputs = {
    ...
    buf.url = github:defn/pkg/buf-1.16.0-20?dir=buf;
    operatorsdk.url = github:defn/pkg/operatorsdk-1.28.0-22?dir=operatorsdk;
    goreleaser.url = github:defn/pkg/goreleaser-1.16.2-22?dir=goreleaser;
    cosign.url = github:defn/pkg/cosign-2.0.0-24?dir=cosign;
