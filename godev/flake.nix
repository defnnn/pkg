{
  inputs = {
    goreleaser.url = github:defn/pkg/goreleaser-1.16.2-36?dir=goreleaser;
    buf.url = github:defn/pkg/buf-1.17.0-9?dir=buf;
    operatorsdk.url = github:defn/pkg/operatorsdk-1.28.0-36?dir=operatorsdk;
    cosign.url = github:defn/pkg/cosign-2.0.1-9?dir=cosign;
