{
  inputs = {
    ...
    boundary.url = github:defn/pkg/boundary-0.12.2-7?dir=boundary;
    vault.url = github:defn/pkg/vault-1.13.1-33?dir=vault;
    gh.url = github:defn/pkg/gh-2.27.0-7?dir=gh;
    earthly.url = github:defn/pkg/earthly-0.7.2-33?dir=earthly;
